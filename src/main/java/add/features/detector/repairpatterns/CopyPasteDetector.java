...
public class CopyPasteDetector extends AbstractPatternDetector {
    ...
    public void detect(RepairPatterns repairPatterns) {
        ...
        for (int i = 0; i < operations.size(); i++) {
            ...
            detectOperation(repairPatterns, operationString, operation);
        }
    }

    public void detectOperation(RepairPatterns repairPatterns, Set<String> operationString, Operation operation) {
